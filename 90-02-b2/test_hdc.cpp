...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_LINE] == '1') {
		...
		/* 横线(双向) */
		hdc_line(100, 90, 500, 90, 10, RGB(rand() % 256, rand() % 256, rand() % 256));
		hdc_line(500, 130, 100, 130, 0, RGB(rand() % 256, rand() % 256, rand() % 256));
		...
		/* 45度斜线(双向) */
		hdc_line(130, 130, 500, 500, 30, RGB(rand() % 256, rand() % 256, rand() % 256));
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		*/
		...
		hdc_draw_Mathematical_curve_2253731();
		to_be_continued("数学曲线-2253731-完成", STL_X, STL_Y);
	}
